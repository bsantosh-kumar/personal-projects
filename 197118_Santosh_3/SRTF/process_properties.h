...
void intializeProperties(processProperties *currProcess) {
    ...
    currProcess->allProperties[4] = &(currProcess->frt);
    currProcess->allProperties[5] = &(currProcess->ct);
    currProcess->allProperties[6] = &(currProcess->tt);
    currProcess->allProperties[7] = &(currProcess->wt);
}
