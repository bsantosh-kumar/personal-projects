...
void create_shell_process(void)
{
	...
	//char *argm[] = { "matmult", "4", NULL};

	//syscall_exectask("matmult", argm, envp, PROC_TYPE_APPLICATION);
...
//	mksysthread(dummythread1, "DUMMY 4", 0, 28);
	...
	printk("\n Use help to display list of internal commands");
	printk("\n Use help <cmd> to display usage of cmd");
